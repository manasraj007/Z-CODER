...
import { Postcomment,Delcommnet,Upvotecomment,Commnets } from '../controller/comment-controller.js';
...
route.delete('/LogIn/:id/:qid/Del-Comment/:cid',authMiddleware,Delcommnet);
route.post('/LogIn/:id/:qid/Comment/:cid/Comment-UpVote',authMiddleware,Upvotecomment);
route.get('/LogIn/:id/:qid/Comment',authMiddleware,Commnets);
...
route.post('/CodeEditor/:lang',CodeEditorFunc);
